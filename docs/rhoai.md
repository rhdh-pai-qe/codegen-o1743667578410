...
3) Access the `workbench` named `codegen-o1743667578410-notebook`.
...
5) In the terminal, run `cd codegen-o1743667578410` to navigate to your sample app's directory.
